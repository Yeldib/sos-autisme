...
class Pagination {
    /**
     * Nom de l'entité sur laquelle on veut faire une pagination
     *
     * @var string
     */
    private $entityClass;
     ...
     * 
     * Configurer votre fichier services.yaml afin que Symfony sache quelle valeur
    ...
    public function getPages()
    {
        if (empty($this->entityClass)) {
            ...
            throw new \Exception("Il faut spécifier une entité pour permettre la pagination. Utiliser la méthode setEntityClass() via l'objet Pagination");
            
        }
        // Connaitre le total des enregistrements d'une table
        $total = count($this->manager
                            ->getRepository($this->entityClass)
                            ->findAll());

        // Faire la division, l'arrondi et retourner
